...
public class FetchStudentListServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        for (StudentEntity student : results) {
            ...
            responseText.append("<tr><td>").append(student.getId()).append("</td><td>").append(student.getNume())
                    .append("</td><td>").append(student.getPrenume())
                    .append("</td><td>").append(student.getVarsta())
                    .append("</td><td><a href='actualizeaza.jsp?id=").append(student.getId()).append("'>Actualizeaza</a></td>")
                    .append("<td><a href='./delete-student?id=").append(student.getId()).append("'>Sterge</a>").append("</td></tr>");
        }
